<template>
  <svg v-if="icon == 'oval'" :class="[styles.loading, props.class || '']" width="25" viewBox="-2 -2 42 42"
  ...
  <svg v-else-if="icon == 'dots'" :class="[styles.loading, props.class || '']" width="25" viewBox="0 0 120 30"
